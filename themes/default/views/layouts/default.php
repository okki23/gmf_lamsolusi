...
<link rel="stylesheet" type="text/css" href="<?php echo $this->config->base_url(); ?>assets/css/bootstrap.paper.css">
...
<?php 
	$animate=array("bounce","flipOutX","zoomInUp","bounceInDown","bounceInLeft","bounceInRight","fadeInLeft","flipInY");
	$random_animate=array_rand($animate,2);
?>
<div id="wrapper " >
	<div class="container  ">
		<div id="main" class="">
			<div class="panel panel-primary animated <?php echo $animate[$random_animate[0]]; ?>" id="curPanel">
...
$(document).ready(function(){
	setTimeout(function(){
            $("#curPanel").removeClass('<?php echo $animate[$random_animate[0]]; ?>')},1000);
});
	kendo.culture("de-DE");
